 ...
 *
 */
public class ConcurrentCollectionExecutor implements Collection {
	 ...
	 * @param handler
	 */
	public ConcurrentCollectionExecutor(Function handler) {
	 ...
	 * @param handler
	 */
	public ConcurrentCollectionExecutor(ExecutorService executor, Function handler) {
	...
	private class QueueIterator implements Iterator {
		...
		public boolean hasNext() {		
			if (!finalized)
				throw new RuntimeException("Invalid state, " + ConcurrentCollectionExecutor.class.getSimpleName() + " should be finalized.");
